...
// exist as static assets. Pages Functions run before static asset serving,
// which makes this authoritative. (Same pattern as the blocker-hardening
// branch, extended with /drafts and /verification.md.)
